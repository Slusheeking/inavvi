    ...
    return html.Div(
        [
            dbc.Row(
                [
                    dbc.Col(
                        html.H1("Day Trading System", className="display-4 text-white"), width=6
                    ),
                    dbc.Col(
                        [
                            dbc.Row(
                                    ...
                                    dbc.Col(
                                        html.Div(
                                            [
                                                ...
                                                html.Span(
                                                    settings.trading.mode.capitalize(),
                                                    id="trading-mode",
                                ...
                                [
                                    ...
                                    dbc.Col(
                                        html.Div(
                                            [
                                                html.Span(
                                                    "Last Update: ", className="font-weight-bold"
                                                ),
                                                html.Span(
...
def create_watchlist_table():
    ...
    return dbc.Card(
        [
            ...
            dbc.CardBody([html.Div(id="watchlist-table", className="table-responsive")]),
        ],
        className="mb-4",
        style={"backgroundColor": COLORS["card_background"]},
    )
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.H3(
                                                "$0.00", id="daily-pnl", className="text-white"
                                            ),
                                        ],
                                        className="text-center mb-3",
                                    )
                                ...
                                [
                                    html.Div(
                                        [
                                            ...
                                            html.H3(
                                                "0 / 3", id="position-count", className="text-white"
                                            ),
                                        ],
                                        className="text-center mb-3",
                                    )
...
def create_trades_table():
    ...
    return dbc.Card(
        [
            ...
            dbc.CardBody([html.Div(id="trades-table", className="table-responsive")]),
        ],
        className="mb-4",
        style={"backgroundColor": COLORS["card_background"]},
    )
    ...
    return dbc.Card(
        [
            dbc.CardHeader(
                [
                    dbc.Row(
                        [
                            dbc.Col(
                                html.H5("Chart", id="chart-title", className="text-white"), width=6
                            ),
                            dbc.Col(
                                [
                                    dbc.Select(
            ...
            dbc.CardBody(
                [
                    dcc.Graph(
                        id="price-chart", config={"displayModeBar": True}, style={"height": "500px"}
                    )
                ]
            ),
        ],
                            ...
                            dbc.Col(
                                [
                                    html.Div(
                                        [
                                            html.H6(
                                                "System Information", className="text-white-50"
                                            ),
                                            html.Div(
                                                [
                                                    html.Div(
                                                    ...
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Span(
                                                                str(settings.trading.max_positions),
                                                                className="text-white",
                                                            ),
                                                        ]
                                                    ),
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Span(
                                                                f"${settings.trading.max_position_size}",
                                                                className="text-white",
                                                            ),
                                                        ]
                                                    ),
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Span(
                                                                f"${settings.trading.max_daily_risk}",
                                                                className="text-white",
                                                            ),
                                                        ]
                                                    ),
                                                    html.Div(
                                                        [
                                                            ...
                                                            html.Span(
                                                                str(
                                                                    settings.trading.watchlist_size
                                                                ),
                                                                className="text-white",
                                                            ),
                                                        ]
...
def create_candlestick_chart(df, title="Price Chart"):
    ...
    # Add volume bars
    colors = [
        COLORS["chart"]["volume_up"]
        if row["close"] >= row["open"]
        else COLORS["chart"]["volume_down"]
    ...
    # Update Y-axis
    fig.update_yaxes(title_text="Price", gridcolor=COLORS["chart"]["grid"], row=1, col=1)
    fig.update_yaxes(title_text="Volume", gridcolor=COLORS["chart"]["grid"], row=2, col=1)

    # Update X-axis
    fig.update_xaxes(gridcolor=COLORS["chart"]["grid"], row=1, col=1)
    fig.update_xaxes(gridcolor=COLORS["chart"]["grid"], row=2, col=1)
...
def create_performance_chart(data, title="Performance"):
    ...
    # Update Y-axis
    fig.update_yaxes(title_text="USD", gridcolor=COLORS["chart"]["grid"])

    # Update X-axis
    fig.update_xaxes(gridcolor=COLORS["chart"]["grid"])
...
def create_sector_performance_chart(data, title="Sector Performance"):
    ...
    # Create dataframe
    df = pd.DataFrame({"Sector": sectors, "Performance": performances})
    ...
    # Update X-axis
    fig.update_xaxes(title_text="Performance (%)", gridcolor=COLORS["chart"]["grid"])

    # Update Y-axis
    fig.update_yaxes(gridcolor=COLORS["chart"]["grid"])
...
def create_watchlist_table_content(data):
    ...
    for item in data:
        ...
        row = html.Tr(
            [
                html.Td(
                    html.A(symbol, href="#", id=f"symbol-link-{symbol}", className="text-white")
                ),
    ...
    # Create table
    table = dbc.Table(
        [header, body], bordered=False, dark=True, hover=True, responsive=True, striped=True
    )
...
def create_positions_table_content(data):
    ...
    for symbol, position in data.items():
        ...
        row = html.Tr(
            [
                html.Td(
                    html.A(symbol, href="#", id=f"position-link-{symbol}", className="text-white")
                ),
                ...
                html.Td(
                    [
                        dbc.Button(
                            "Exit",
                            id=f"exit-pos-btn-{symbol}",
                            color="danger",
                            size="sm",
                            className="mr-1",
                        ),
                        dbc.Button(
                            "Chart", id=f"chart-pos-btn-{symbol}", color="primary", size="sm"
                        ),
                    ],
                    className="text-center",
                ),
...
def generate_sample_data():
        ...
        watchlist.append(
            {
                ...
                "pattern": {
                    "name": np.random.choice(
                        ["breakout", "reversal", "continuation", "no_pattern"]
                    ),
    ...
    for _i in range(10):
        ...
        reason = np.random.choice(
            ["market_open", "take_profit", "stop_loss", "trailing_stop", "exit_signal"]
        )
