...
from src.models import RankingModel, SentimentModel, PatternRecognitionModel
...
def mock_data_sources():
    ...
    with mock.patch('src.data_sources.alpha_vantage_client') as alpha_mock, \
        ...
        yield {
            "alpha_vantage": alpha_mock,
            "polygon": polygon_mock,
