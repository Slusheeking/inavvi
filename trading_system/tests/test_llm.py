...
from src.llm.parsing import extract_json_from_text, parse_trade_decision, parse_exit_decision
...
Let me know if you need any other information!"""
        ...
        self.assertEqual(decision["key_factors"], ["breakout pattern", "positive sentiment", "bullish market"])
...
Let me know if you need any other information!"""
        ...
        self.assertEqual(decision["reasoning"], "Taking partial profits with RSI approaching overbought")
        self.assertEqual(decision["key_factors"], ["profit target reached", "overbought indicators", "time in trade"])
...
The main factors are the strong breakout pattern, positive sentiment, and bullish market conditions."""
    ...
    def test_parse_exit_decision_valid(self):
        ...
        exit_json = self.json_in_code_block.replace("trade", "exit").replace("position_size", "exit_size")
